      ...
      >
        <input
          ...
          onChange={(e) => {
            ...
            isSoundEnabled ? playRandomKeyStrokeSound() : null;
          }}
          className="text-white/70 flex-1 bg-slate-800/50 border border-slate-700/50 rounded-lg py-2 px-4 placeholder:text-slate-400"
